...
publish:
	cd rabbitmq-perf-test && make ARGS="--uri amqp://$(RMQ_HOST) --predeclared --queue rabbitmq-users-9_ohuUbX9NY --pmessages 65536 --producers 1 --consumers 0 --confirm 16 --size 81920" run
